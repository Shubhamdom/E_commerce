...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        files_to_rename = ['wholeseller/settings/base.py', 'wholeseller/wsgi.py', 'manage.py']
        folder_to_rename = 'wholeseller'

        for f in files_to_rename:
            with open(f, 'r')as file:
                filedata = file.read()

            filedata = filedata.replace('wholeseller', new_project_name)
